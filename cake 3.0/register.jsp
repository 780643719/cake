...
<div class="div_login_head">注册</div> 
        	<div class="div_top_2">
        	</div>
...
确认密码：<input class="input_pwd" type="password" name="cuserpwd" placeholder="请确认密码"><br>
        	<div class="div_top_2">
        	</div>
        <button class="button_login" type="submit" value="login">注册</button><button class="button_login" value="login"type="reset" >重置</button>
        <br>
    </form>
</div>
	<!-- footer -->
